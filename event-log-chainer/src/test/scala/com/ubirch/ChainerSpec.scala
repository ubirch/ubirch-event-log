...
class InjectorHelperImpl(bootstrapServers: String, consumerTopic: String, producerTopic: String, minTreeRecords: Int = 10, treeEvery: Int = 60) extends InjectorHelper(List(new ChainerServiceBinder {
