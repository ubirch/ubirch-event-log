...
object Params {
  def get[T <: Params](maybeConsumerRecord: Option[ConsumerRecord[String, String]], paramsHelper: ParamsHelper[T]) = {
    maybeConsumerRecord
  ...
  def getOrElse[T <: Params](maybeConsumerRecord: Option[ConsumerRecord[String, String]], paramsHelper: ParamsHelper[T], orElse: T) =
