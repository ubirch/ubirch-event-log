...
The most important aspect of these endpoints is that we are introducing an 'ACCESS_TOKEN'. All the endpoints described here must use a valid access token.
