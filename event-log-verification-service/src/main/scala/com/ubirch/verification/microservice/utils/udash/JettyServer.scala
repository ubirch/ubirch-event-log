package com.ubirch.verification.microservice.utils.udash

import com.typesafe.scalalogging.StrictLogging
import com.ubirch.verification.microservice.Api
...
class JettyServer @Inject()(api: Api, docs: OpenApi, port: Int) extends StrictLogging {
  ...
  def rest[RestApi: RawRest.AsRawRpc : RestMetadata](apiImpl: RestApi,
                                                     handleTimeout: FiniteDuration = DefaultHandleTimeout,
                                                     maxPayloadSize: Long = DefaultMaxPayloadSize): RestServlet = {
