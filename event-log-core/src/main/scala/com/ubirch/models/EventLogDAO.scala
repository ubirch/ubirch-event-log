...
/**
  ...
  */
@Singleton
class Events @Inject() (val connectionService: ConnectionService)(@Named("logger") implicit val ec: ExecutionContext) extends EventLogQueries {
...
@Singleton
class EventsDAO @Inject() (val events: Events, val lookups: Lookups)(@Named("logger") implicit val ec: ExecutionContext) {
